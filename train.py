...
def build_int_feature_specs_with_fid(
    ...
    """Build int feature specs of the form ``[(fid, vocab_size, offset, length), ...]``."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_ema', action='store_true', default=True,
                        help='Use EMA dense weights for validation and best checkpoint (default on)')
    parser.add_argument('--no_ema', dest='use_ema', action='store_false',
                        help='Disable EMA for validation and best checkpoint')
    parser.add_argument('--ema_decay', type=float, default=0.999,
                        help='EMA decay used for dense-parameter shadow weights')
    ...
    parser.add_argument('--use_time_period_feats', action='store_true', default=True,
                        help='Enable Beijing-local hour/weekday sin-cos time features (default on)')
    parser.add_argument('--no_time_period_feats', dest='use_time_period_feats', action='store_false',
                        help='Disable Beijing-local hour/weekday sin-cos time features')
...
def main() -> None:
    ...
    model_args = {
        ...
        "user_dense_feature_specs": build_dense_feature_specs(pcvr_dataset.user_dense_schema),
        "user_int_feature_specs_with_fid": build_int_feature_specs_with_fid(
            pcvr_dataset.user_int_schema, pcvr_dataset.user_int_vocab_sizes),
        ...
        "use_time_period_feats": args.use_time_period_feats,
